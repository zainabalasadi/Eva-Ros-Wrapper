...
(cl:defclass <EvaJoint> (roslisp-msg-protocol:ros-message)
  ((j1
    :reader j1
    :initarg :j1
    :type cl:float
...
(cl:defclass EvaJoint (<EvaJoint>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EvaJoint>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EvaJoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eva_driver-msg:<EvaJoint> is deprecated: use eva_driver-msg:EvaJoint instead.")))

(cl:ensure-generic-function 'j1-val :lambda-list '(m))
(cl:defmethod j1-val ((m <EvaJoint>))
...
(cl:defmethod j2-val ((m <EvaJoint>))
...
(cl:defmethod j3-val ((m <EvaJoint>))
...
(cl:defmethod j4-val ((m <EvaJoint>))
...
(cl:defmethod j5-val ((m <EvaJoint>))
...
(cl:defmethod j6-val ((m <EvaJoint>))
  ...
  (j6 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EvaJoint>) ostream)
  "Serializes a message object of type '<EvaJoint>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EvaJoint>) istream)
  "Deserializes a message object of type '<EvaJoint>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EvaJoint>)))
  "Returns string type for a message object of type '<EvaJoint>"
  "eva_driver/EvaJoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EvaJoint)))
  "Returns string type for a message object of type 'EvaJoint"
  "eva_driver/EvaJoint")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EvaJoint>)))
  "Returns md5sum for a message object of type '<EvaJoint>"
  "30e3b3187560ea4f8505d287c27ca8d4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EvaJoint)))
  "Returns md5sum for a message object of type 'EvaJoint"
  "30e3b3187560ea4f8505d287c27ca8d4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EvaJoint>)))
  "Returns full string definition for message of type '<EvaJoint>"
  (cl:format cl:nil "# EvaJoint.msg~%~%float64 j1~%float64 j2~%float64 j3~%float64 j4~%float64 j5~%float64 j6~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EvaJoint)))
  "Returns full string definition for message of type 'EvaJoint"
  (cl:format cl:nil "# EvaJoint.msg~%~%float64 j1~%float64 j2~%float64 j3~%float64 j4~%float64 j5~%float64 j6~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EvaJoint>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EvaJoint>))
